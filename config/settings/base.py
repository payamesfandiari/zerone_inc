...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres:///zerone_inc")
}
...
MIGRATION_MODULES = {"sites": "zerone_inc.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "zerone_inc.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Payam Esfandiari""", "p.esfandiari@uzer.one")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "zerone_inc.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "zerone_inc.users.adapters.SocialAccountAdapter"
